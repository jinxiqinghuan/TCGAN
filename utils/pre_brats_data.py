...
# -----------------------
#  Brats 2020数据集二维切片预处理
# -----------------------

# 训练集
root = '/root/cloud_hard_drive/datasets/Brats2020/MICCAI_BraTS2020_TrainingData/'
sum_rows = 240
sum_cols = 480
# new image
...
for i in tqdm(range(369)):
    path = root + "/BraTS20_Training_%03d" % (i+1)
    # print(path)
    t1_path = path + r"/BraTS20_Training_%03d_t1.nii.gz" % (i+1)
    t2_path = path + r"/BraTS20_Training_%03d_t2.nii.gz" % (i+1)
...
#     max_list.append(t1.max())
#     max_list.append(t2.max())
#     min_list.append(t1.min())
#     min_list.append(t2.min())
# print(max(max_list))
# print(min(min_list)) 
    ...
    for j in range(0, 155, 1):
        ...
        # final_matrix
        imageio.imwrite("/home/gxzy/ljt/project/pet2ct/brats2020/train/t1_t2_{}_{}.png".format(i, j), final_matrix)
