...
class TransGeneratorUNetV3(nn.Module):
    def __init__(self, in_channels=1, out_channels=1, depth1=5, depth2=4, depth3=2, initial_size=8, dim=384, heads=4, mlp_ratio=4, drop_rate=0.2):
        super(TransGeneratorUNetV3, self).__init__()
    ...
    def forward(self,x):
        ...
        t1 = self.trans_down1(trans_input)
        ...
        x = self.trans_up3(x, trans_input)

        out2 = self.out_layer(x)
...
class RTGAN(nn.Module):
    def __init__(self, in_channels=1, out_channels=1, depth1=5, depth2=4, depth3=2, initial_size=8, dim=384, heads=4, mlp_ratio=4, drop_rate=0.2):
        super(RTGAN, self).__init__()
    ...
    def forward(self,x):
        ...
        t1 = self.trans_down1((trans_input+out1) / 2)
        t2 = self.trans_down2(t1)
        t3 = self.trans_down3(t2)
...
if __name__ == '__main__':
    ...
    model = TransGeneratorUNetV3(in_channels=1, out_channels=1, depth1=5, depth2=4, depth3=2, initial_size=8, dim=1024, heads=4, mlp_ratio=4, drop_rate=0.2)#,device = device)
